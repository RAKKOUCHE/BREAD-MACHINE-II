...
{
    /* Initialize I2C0 */
    PLIB_I2C_BaudRateSet(I2C_ID_3, SYS_CLK_PeripheralFrequencyGet(CLK_BUS_PERIPHERAL_1), 100000);
...
void DRV_I2C0_BaudRateSet(I2C_BAUD_RATE baudRate)
{
    ...
    /* Change baud rate */
    PLIB_I2C_BaudRateSet(I2C_ID_3, SYS_CLK_PeripheralFrequencyGet(CLK_BUS_PERIPHERAL_1), baudRate);
