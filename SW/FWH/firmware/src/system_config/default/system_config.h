...
#define SYS_PORT_AD1PCFG        ~0xe000
#define SYS_PORT_CNPUE          0xf3002
#define SYS_PORT_CNEN           0x0
#define SYS_PORT_A_TRIS         0x3D00
...
/*** Functions for GSM_PWRKEY pin ***/
#define GSM_PWRKEYToggle() PLIB_PORTS_PinToggle(PORTS_ID_0, PORT_CHANNEL_G, PORTS_BIT_POS_12)
#define GSM_PWRKEYOn() PLIB_PORTS_PinSet(PORTS_ID_0, PORT_CHANNEL_G, PORTS_BIT_POS_12)
#define GSM_PWRKEYOff() PLIB_PORTS_PinClear(PORTS_ID_0, PORT_CHANNEL_G, PORTS_BIT_POS_12)
#define GSM_PWRKEYStateGet() PLIB_PORTS_PinGetLatched(PORTS_ID_0, PORT_CHANNEL_G, PORTS_BIT_POS_12)
#define GSM_PWRKEYStateSet(Value) PLIB_PORTS_PinWrite(PORTS_ID_0, PORT_CHANNEL_G, PORTS_BIT_POS_12, Value)
...
/*** Functions for GSM_STAT pin ***/
#define GSM_STATStateGet() PLIB_PORTS_PinGet(PORTS_ID_0, PORT_CHANNEL_G, PORTS_BIT_POS_14)

/*** Functions for GSM_RI pin ***/
#define GSM_RIStateGet() PLIB_PORTS_PinGet(PORTS_ID_0, PORT_CHANNEL_G, PORTS_BIT_POS_13)
...
#define GSM_RTS_PORT PORT_CHANNEL_F
#define GSM_RTS_PIN PORTS_BIT_POS_13
#define GSM_RTS_PIN_MASK (0x1 << 13)
