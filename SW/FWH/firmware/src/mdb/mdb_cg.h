...
#define COIN_REFUSED 0B00100000
    ...
    typedef struct
    {
        uint8_t byFull[2]; /*!< Chaque bit contient un flag indiquant si le tube correspondant est plein.*/
        uint8_t byLevel[16]; /*!< Niveau du tube correspondant à la position de l'cotet dans le buffer.*/
    } TUBE_STATUS;
